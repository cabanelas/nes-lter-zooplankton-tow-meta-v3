...
Version 3 extends the published v2 package (which had up to cruise EN720) by adding the 2024–2026 cruises **AE2426, EN727, AR88, AR92, AR95, AR99, HRS2601, and HRS2609**, and adds the `depth_PX` sensor field (Kongsberg Simrad PX, starting AE2426) and separate ring-net tow logging (starting AR99).
